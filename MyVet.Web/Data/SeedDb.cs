    ...
    public class SeedDb
    {
        ...
        private async Task CheckPetTypesAsync()
        {
            if (!_context.PetTypes.Any())
            {
                ...
                _context.PetTypes.Add(new PetType { Name = "CatDog" });
                await _context.SaveChangesAsync();
            }
        }
        ...
        private async Task CheckOwnersAsync()
        {
            ...
            {
                AddOwner("8989898", "Juan", "Galindo", "234 3232", "310 322 3221", "Calle Luna Calle Sol");
                AddOwner("7655544", "Jose", "Taborda", "343 3226", "300 322 3221", "Calle 77 #22 21");
                AddOwner("6565555", "Maria", "Londoño", "450 4332", "350 322 3221", "Carrera 56 #22 21");
                await _context.SaveChangesAsync();
            }
        }
            ...
            if (!_context.Agenda.Any())
            {
                ...
                while (initialDate < finalDate)
                {
                    if (initialDate.DayOfWeek != DayOfWeek.Sunday)
                    {
                        ...
                        {
                            _context.Agenda.Add(new Agenda
                            {
